...
Public Class reportPetList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pet_Management_Solution.reportPetList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreportPetList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reportPetList = New reportPetList()
        rpt.Site = Me.Site
        Return rpt
    End Function
