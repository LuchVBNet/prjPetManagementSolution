...
Public Class rptPetsList
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pet_Management_Solution.rptPetsList.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPetsList
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPetsList = New rptPetsList()
        rpt.Site = Me.Site
        Return rpt
    End Function
