...
Public Class crystalPets
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pet_Management_Solution.crystalPets.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrystalPets
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crystalPets = New crystalPets()
        rpt.Site = Me.Site
        Return rpt
    End Function
