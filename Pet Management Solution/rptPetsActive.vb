...
Public Class rptPetsActive
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Pet_Management_Solution.rptPetsActive.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptPetsActive
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptPetsActive = New rptPetsActive()
        rpt.Site = Me.Site
        Return rpt
    End Function
